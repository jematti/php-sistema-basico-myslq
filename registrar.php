...
if (isset($_POST["insertar"])) 
{
		...
		$sql="INSERT INTO inscritos(
		 ...
		 VALUES ('$v1', $cel, $cel_ref, '$equipos', '$formacion', '$condicion_lab', '$correo_per', '$correo_umsalud', '$correo_umsa', '$funciones_resumen', '$equipos_laboral', '$patologia_base',1 ,'$activo_patologia')";
...
?>
			...
			<div class="container-fluid">
				<form action="" class="form-neon" autocomplete="off" method="post">
						...
						<div class="container-fluid">
							<div class="row">
								...
								<h5> <strong>Condicion Laboral:</strong> </h5>
											...
											<div class="form-check">
											<input class="form-check-input" type="checkbox" value="De planta" name="condicion_lab[]" id="defaultCheck1" checked>
											<label class="form-check-label" for="defaultCheck1">
											  De Planta
											</label>
											</div>
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									...
									<h5><strong>Correo Institucional (@umsalud.edu.bo)</strong></h5>
										<input type="text" class="form-control" name="correo_umsalud" value="@umsalud.edu.bo"  maxlength="170" >
									</div>
								</div>
								...
								<div class="col-12 col-md-12">
									...
									<h5><strong>Correo Institucional (@umsa.bo)</strong></h5>
										<input type="text" class="form-control" name="correo_umsa" value="@umsa.bo"  maxlength="170" >
									</div>
								</div>
					...
					<!-- fin seccion de datos opcionales -->
